  ...
  const [testimonialSlider, settestimonialSlider] = useState([
    {
      id: "slider1",
      img: TestimonialImg1,
      desc: "Gracias a la campaña médica gratuita, mi hija recibió atención especializada sin costo.",
      name: "Juana Quispe - Comunidad de Pampa Anza",
    },
    {
      id: "slider2",
      img: TestimonialImg2,
      desc: "Recibimos ayuda humanitaria tras el deslizamiento en nuestra zona. Agradezco al equipo municipal.",
      name: "José Huamani - Barrio Central",
    },
    {
      id: "slider3",
      img: TestimonialImg3,
      desc: "Me orientaron rápidamente para regularizar mi predio. El trámite fue ágil y el personal muy amable.",
      name: "María Ccapa - Urbanización Santa Rosa",
    },
    {
      id: "slider4",
      img: TestimonialImg2,
